...
const HeroSection = () => {
  return (
    <div id="hero" className="relative text-white font-anton font-extrabold w-full h-[663px] overflow-hidden">
      <img
        src={heroImage}
        alt="Hero Background"
      ...
      <h1 className="text-[56px] font-anton absolute top-[40%] left-[10%] font-black ">
